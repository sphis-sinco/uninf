...
public final class GuiMainMenu extends GuiScreen {
	...
	private String[] splashes = new String[] { "As seen on TV!", "Awesome!", "100% pure!",
			"May contain nuts!", "Better than Prey!", "More polygons!", "Sexy!", "Limited edition!",
			"Flashing letters!", "Originally made by Notch!", "Coming soon!", "Best in class!", "When it\'s finished!",
			...
			"Classy!", "Wow!", "Not on steam!", "Oh man!", "Check it out!",
			...
			"Ask your doctor!", "Cloud computing!", "Legal in Finland!", "Hard to label!",
